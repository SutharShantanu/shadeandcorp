...
export function CheckoutAddressForm({
  ...
  return (
    <div className="relative border rounded-xl bg-background overflow-hidden">
      <Form {...form}>
        <form
                      ...
                      <FormControl>
                        <div className="flex gap-2">
                          ...
                          <Button
                            ...
                            className="h-full px-3 border border-dashed border-primary transition-all shrink-0"
                          >
                            {isDetectingLocation ? (
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <CountrySelect
                            value={field.value}
                            className="h-10 bg-muted/20 w-full"
                            onChange={(val: string) => {
                              field.onChange(val);
                              form.setValue("state", "");
                              form.setValue("city", "");
      ...
      <div className="bg-muted/30 border-t border-border p-4 flex justify-end gap-2">
        ...
        <Button type="submit" form="checkout-address-form" disabled={!form.formState.isValid}>
          {submitLabel}
        </Button>
      </div>
    </div>
