        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          <div className="space-y-1">
            ...
            <div className="flex items-center gap-2 mt-1">
              ...
              <p className="text-sm font-medium">{userProfile?.firstName || <span className="text-muted-foreground">N/A</span>}</p>
            </div>
          </div>
          <div className="space-y-1">
            ...
            <div className="flex items-center gap-2 mt-1">
              ...
              <p className="text-sm font-medium">{userProfile?.lastName || <span className="text-muted-foreground">N/A</span>}</p>
            </div>
          </div>
        </div>
      </div>
